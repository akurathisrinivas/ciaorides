...
class Driver_menuitems extends REST_Controller {
    ...
    function get_my_rides_post() {
		...
		*/        
        ...
        foreach ($required_params as $key => $value) {
 		...
 		$rides_taken=$this->drivermenuitems_model->get_rides_taken($user_id);
 		$rides_scheduled=$this->drivermenuitems_model->get_rides_scheduled($user_id);
    ...
    function get_my_vehicle_details_post() {
		...
		*/        
    	...
    	$vehicle_details=$this->drivermenuitems_model->get_vehicle_details($user_id);
    ...
    function my_vehicle_details_delete_post() {
	   ...
	   $required_params = array('user_id' => "User ID",'vehicle_id' => "Vehicle Id",);
        ...
        $deleteVehicle = $this->drivermenuitems_model->delete_vehicle($data, $user_id,$vehicle_id);
...
//         /'vehicle_registration_number' => 'Vehicle registration number'
    ...
    function driver_bank_details_post() {
        ...
        // }
        	...
        	$responseResult=$this->drivermenuitems_model->get_user_bank_details($user_id);
    ...
    function driver_bank_details_delete_post() {
	   ...
	   $required_params = array('user_id' => "User ID",'bank_id' => "Bank Id",);
        ...
        $deleteBankdetails = $this->drivermenuitems_model->delete_bank_details($data, $user_id,$bank_id);
    ...
    function get_favourites_list_post() {
		...
		*/        
    	...
    	$favourites_details=$this->drivermenuitems_model->get_favourites_details($user_id);
    ...
    function driver_favourite_location_delete_post() {
	   ...
	   $required_params = array('user_id' => "User ID",'favourite_id' => "Favourite Id",);
        ...
        $deleteFavourite = $this->drivermenuitems_model->delete_favourite_location($data, $user_id,$favourite_id);
    ...
    function get_emergency_contacts_list_post() {
		...
		*/        
    	...
    	$emergency_contacts_details=$this->drivermenuitems_model->get_emergency_contacts_list($user_id);
  ...
  // change password 
    ...
    function user_profile_post(){
        ...
        $user_details = $this->drivermenuitems_model->user_details($user_id);
    ...
    function my_payments_post(){
        ...
        $user_paymnets = $this->drivermenuitems_model->get_my_paymnets($user_id);
    ...
    function my_earnings_post(){
        ...
        $user_paymnets = $this->drivermenuitems_model->get_my_earnings($user_id);
