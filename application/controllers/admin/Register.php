...
//        print_r($users);
    ...
    public function amount_calculations() {
        ...
        $this->load->view('admin/list_amount_calculations', $data);
    ...
    public function add_amount_calculations() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/add_amount_calculations', $data);
        $this->load->view('admin/includes/footer', $data);
    }

    public function edit_amount_calculations($id) {
        $data['title'] = "CIAO Rides";
        $data['row'] = get_table_row('amount_calculations', array('id' => $id));
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/edit_amount_calculations', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function update_amount_calculations() {
        ...
        if ($this->input->post('amount_calculations_id') == "") {
            ...
            insert_table('amount_calculations', $data, '', false);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            redirect('admin/register/add_amount_calculations', 'refresh');
        } else {
            $data['modified_on'] = date('Y-m-d H:i:s');
            update_table('amount_calculations', $data, array('id' => $this->input->post('amount_calculations_id')));
    ...
    public function chats() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_chats', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_chats() {
        ...
        $data['details'] = $this->registermodel->get_user_chats($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_chats', $data);
    }
    ...
    public function rider_current_location() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_rider_current_location', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_rider_current_location() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_rider_current_location($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_rider_current_location', $data);
    }
    ...
    public function emergency_contacts() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_emergency_contacts', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_emergency_contacts() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_emergency_contacts($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_emergency_contacts', $data);
    }
    ...
    public function favourite_locations() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_favourite_locations', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_favourite_locations() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_favourite_locations($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_favourite_locations', $data);
    }
    ...
    public function rides() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_rides', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_rides() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_rides($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_rides', $data);
    }
...
//        echo '</pre>';
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/ride_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function ongoing() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_ongoing', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_ongoing() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_ongoing($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_ongoing', $data);
    }
    ...
    public function ongoing_details() {
        ...
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/ongoing_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function completed() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_completed', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_completed() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_completed($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_completed', $data);
    }
    ...
    public function completed_details() {
        ...
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/completed_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function shceduled() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_shceduled', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_shceduled() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_shceduled($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_shceduled', $data);
    }
    ...
    public function shceduled_details() {
        ...
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/shceduled_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function ride_lat_lngs() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_ride_lat_lngs', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_ride_lat_lngs() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_ride_lat_lngs($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_ride_lat_lngs', $data);
    }
    ...
    public function user_bank_details() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_user_bank_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_user_bank_details() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_user_bank_details($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_user_bank_details', $data);
    }
    ...
    public function user_feedback() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_user_feedback', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_user_feedback() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_user_feedback($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_user_feedback', $data);
    }
    ...
    public function user_ratings() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_user_ratings', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_user_ratings() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_user_ratings($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_user_ratings', $data);
    }
    ...
    public function user_vehicles() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_user_vehicles', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_user_vehicles() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_user_vehicles($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_user_vehicles', $data);
    }
    ...
    public function vehicle_makes() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_vehicle_makes', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function add_vehicle_makes() {
        ...
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/add_vehicle_makes', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function update_vehicle_makes() {
        ...
        if ($this->input->post('category_id') == "") {
            $data['created_on'] = date('Y-m-d H:i:s');
            $this->registermodel->insert_vehicle_makes($data);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            redirect('admin/register/add_vehicle_makes', 'refresh');
        } else {
            // var_dump($data);exit;
            $data['modified_on'] = date('Y-m-d H:i:s');
            $this->registermodel->update_vehicle_makes($data, $this->input->post('category_id'));
            $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function edit_vehicle_makes($vehicle_makes_id) {
        ...
        //var_dump($data['row']);
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/edit_vehicle_makes', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_vehicle_makes() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_vehicle_makes($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_vehicle_makes', $data);
    }
    ...
    public function vehicle_models() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_vehicle_models', $data);
        $this->load->view('admin/includes/footer', $data);
    }

    public function add_vehicle_models() {
        $data['title'] = "CIAO Rides";
        $data['categories'] = $this->registermodel->vehicle_makes();
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/add_vehicle_models', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function update_vehicle_models() {
        ...
        if ($this->input->post('sub_category_id') == "") {
            ...
            $this->registermodel->insert_vehicle_models($data);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            ...
            $data['modified_on'] = date('Y-m-d H:i:s');
            $this->registermodel->update_vehicle_models($data, $this->input->post('sub_category_id'));
            $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function edit_vehicle_models($vehicle_models_id) {
        ...
        $data['categories'] = $this->registermodel->vehicle_makes();
        $data['sub_categories'] = $this->registermodel->vehicle_models();


        //	var_dump($data['row']);
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/edit_vehicle_models', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_vehicle_models() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_vehicle_models($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_vehicle_models', $data);
    }
    ...
    public function otherorders() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_otherorders', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_otherorders() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_otherorders($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_otherorders', $data);
    }
    ...
    public function instantorders() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_instantorders', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_user_instantorders() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_user_instantorders($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_user_instantorders', $data);
    }
...
//all_instantorders
    ...
    public function all_bookings() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_all_bookings', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function user_payments() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_user_payments', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function user_refunds() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_user_refunds', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function rider_pending_payments() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_rider_pending_payments', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function rider_paid_payments() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_rider_paid_payments', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function cancelled_rider() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_cancelled_rider', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_cancelled_rider_user() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_cancelled_rider_user($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_cancelled_rider_user', $data);
    }
    ...
    public function cancelled_rider_details() {
        ...
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/cancelled_rider_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function cancelled_user() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_cancelled_user', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function get_cancelled_user_user() {
        $data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $data['details'] = $this->registermodel->get_cancelled_user_user($user_id);
        //var_dump($data['row']);
        $this->load->view('admin/get_cancelled_user_user', $data);
    }
    ...
    public function cancelled_user_details() {
        ...
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/cancelled_user_details', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    function all_users() {
        ...
        #pagination code end
        //$data['webprofile'] = $this->Main_model->webprofile();
        $data['photo'] = $this->registermodel->photo_gal($config['per_page'], $start);
        // 		$this->front_view('sample',$data);

        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/all_users_list', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function inactiveusers() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_inactiveusers', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function otherusers() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_otherusers', $data);
        $this->load->view('admin/includes/footer', $data);
    }
...
//            die;
    ...
    public function update_verification() {
        ...
        $this->registermodel->update_verification($data, $this->input->post('status_id'));
        $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function push_notifications() {
        $data['title'] = "Bikes7";
        $data['items'] = $this->registermodel->all_push_notifications($_POST);
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_push_notifications', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function push_notificationsView() {
        ...
        //var_dump($data['row']);
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/push_notifications_view', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function support() {
        $data['title'] = "CIAO Rides";
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/list_support', $data);
        $this->load->view('admin/includes/footer', $data);
    }
    ...
    public function update_support() {
        if ($this->input->post('sub_category_id') == "") {
            ...
            $this->registermodel->insert_support($data);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            ...
            $data['modified_on'] = date('Y-m-d H:i:s');
            $this->registermodel->update_support($data, $this->input->post('sub_category_id'));
            $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function edit_support($support_id) {
        ...
        $data['categories'] = $this->registermodel->vehicle_makes();
        $data['sub_categories'] = $this->registermodel->support();
...
//        echo '</pre>';
        ...
        $data['social'] = $this->db->get('socia_media_links')->result();
        $message = $this->load->view('website/invoice-test', $data, false);
    }
